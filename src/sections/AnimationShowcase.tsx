    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Современные <span className="text-accent">анимации</span> и 3D-графика
          </motion.h2>
          
          <motion.p 
            className="text-xl text-foreground/90 mb-8 max-w-3xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={isVisible ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            Использую передовые технологии для создания интерактивных и визуально впечатляющих веб-приложений
          </motion.p>
          ...
          >
            <div className="bg-background/70 backdrop-blur-sm p-6 rounded-xl border border-gray-800 shadow-lg">
              <h3 className="text-xl font-semibold text-foreground mb-3">Three.js</h3>
            ...
            <div className="bg-background/70 backdrop-blur-sm p-6 rounded-xl border border-gray-800 shadow-lg">
              <h3 className="text-xl font-semibold text-foreground mb-3">GSAP</h3>
              <p className="text-foreground/80">
            ...
            <div className="bg-background/70 backdrop-blur-sm p-6 rounded-xl border border-gray-800 shadow-lg">
              <h3 className="text-xl font-semibold text-foreground mb-3">Framer Motion</h3>
              <p className="text-foreground/80">
