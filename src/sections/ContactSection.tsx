    ...
    <section id="contact" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <h3 className="text-2xl font-bold text-foreground mb-6">Давайте обсудим ваш проект</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium text-foreground">Телефон</h4>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium text-foreground">Местоположение</h4>
