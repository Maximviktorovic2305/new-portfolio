        ...
        >
          ...
          >
            <motion.a
              ...
              whileHover={{ 
                scale: 1.05,
                boxShadow: settings.enabled ? "0 0 20px rgba(116, 221, 227, 0.5)" : "none"
              }}
              whileTap={{ scale: 0.95 }}
            >
              Мои работы
            ...
            <motion.a
              href="#contact"
              className="px-8 py-3 bg-transparent border-2 border-accent text-foreground font-medium rounded-full hover:bg-accent/10 transition-colors duration-300"
              whileHover={{ 
                scale: 1.05,
                boxShadow: settings.enabled ? "0 0 20px rgba(116, 221, 227, 0.3)" : "none"
              }}
              whileTap={{ scale: 0.95 }}
            >
              Связаться
