...
export const projects: Project[] = [
	...
	},
	{
		...
		technologies: ['Next 15', 'Tailwind', 'Shadcn', 'Nest.js', 'CI/CD'],
		category: 'Fullstack',
	...
	{
		id: 3,
		title: 'Туритическая компания',
		description: 'Сайт туристической компании Bitomo',
		technologies: ['Next 15', 'Nest.js', 'Postgres', 'Админка'],
		category: 'Fullstack',
	...
	},
	{
		...
		description: 'Телеграм мини апп сайт компании',
		technologies: ['React 19', 'Redux', 'Tanstack'],
		category: 'Frontend',
	...
	},
	{
		...
		description: 'Сайт мебельной компании Deco',
		technologies: ['Nuxt 4', 'Pinia', 'Nest.js', 'Postgres', 'Админка'],
		category: 'Fullstack',
	...
	},
	{
		...
		description: 'Сайт для путешествий на Сахалине',
		technologies: ['Next 15', 'Redux', 'Nest.js', 'Админка'],
		category: 'Fullstack',
	...
	},
	{
		...
		description: 'Сайт для музея на Сахалине',
		technologies: ['Next 15', 'Zustand', 'Nest.js', 'Админка'],
		category: 'Fullstack',
	...
	},
	{
		id: 8,
		title: 'Сайт JB Rus',
		description: 'Сайт производственной компании',
		technologies: ['Next 15', 'Redux', 'Nest.js', 'Админка'],
		category: 'Fullstack',
		site: 'https://jbrus.ru/',
		github: '',
	...
	{
		id: 9,
		title: 'Сайт Креветка Shop',
		description: 'Сайт компании поставщика морепродуктов',
		technologies: ['Vue 3', 'Pinia', 'Nest.js', 'Postgres', 'Админка'],
		category: 'Fullstack',
