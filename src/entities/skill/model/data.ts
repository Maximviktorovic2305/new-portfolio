...
export const skills: Skill[] = [
  ...
  { name: "SCSS", category: "Frontend", emoji: "🎀", description: "Модульные стили, переменные, миксины и поддерживаемая архитектура CSS для крупных интерфейсов." },
  { name: "Three.js / GSAP / Motion", category: "Frontend", emoji: "✨", description: "3D-графика и продвинутые анимации. Интерактивные интерфейсы на GSAP и Framer Motion." },
  { name: "Redux Toolkit / Zustand", category: "Frontend", emoji: "🧠", description: "Управление клиентским состоянием в React-приложениях: предсказуемые хранилища и модульная архитектура." },
  ...
  { name: "Vite / Webpack", category: "Frontend", emoji: "⚙️", description: "Настройка сборки, оптимизация бандлов, code splitting и окружения для SPA и SSR-проектов." },
  ...
  { name: "Golang", category: "Backend", emoji: "🐹", description: "Разработка производительных микросервисов. Горутины, каналы, конкурентность и интеграция с Node.js-системами." },
  ...
  { name: "Moleculer.js", category: "Backend", emoji: "🧩", description: "Микросервисная архитектура на Node.js: сервисы, брокеры, балансировка и отказоустойчивое взаимодействие." },
  { name: "gRPC", category: "Backend", emoji: "📡", description: "Быстрое типизированное взаимодействие между микросервисами на основе Protocol Buffers." },
  ...
  { name: "TypeORM", category: "Backend", emoji: "🗄️", description: "ORM для TypeScript и Node.js: сущности, связи, миграции, транзакции и QueryBuilder." },
  { name: "Prisma / Sequelize", category: "Backend", emoji: "💾", description: "Типобезопасная работа с данными, модели, миграции и поддерживаемый слой доступа к БД." },
  ...
  { name: "Kubernetes", category: "DevOps", emoji: "☸️", description: "Оркестрация контейнеров, масштабирование микросервисов, управление конфигурацией и стабильными релизами." },
