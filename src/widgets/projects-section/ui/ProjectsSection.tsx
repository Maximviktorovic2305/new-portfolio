...
import { ImageWithFallback, SectionDivider } from "@/shared/ui";
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p
          className="text-[0.85rem] text-muted-foreground mb-3 leading-relaxed"
        ...
        >
          ...
          >
            {isClassic ? (
              ...
              <>
                Мои <span className="text-brand-orange">проекты</span>
              </>
            )}
          </h2>
          {!isClassic && (
        ...
        {!isClassic && (
          <>
            <div className="grid lg:grid-cols-2 gap-6">
              {visibleProjects.map((project, i) => {
                const color = projectColors[i % projectColors.length] ?? colors.lavender;
                  ...
                  >
                    <div className="relative h-56 overflow-hidden">
                      ...
                      <motion.div
                        ...
                        style={{
                          backgroundColor: isCrayon ? "rgba(47, 41, 66, 0.68)" : "rgba(15, 14, 26, 0.76)",
                        }}
                      >
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-3">
                        <h3
                          className="text-[1.2rem] text-text-primary"
                          style={{ fontFamily: "var(--t-font-heading)", fontWeight: 700 }}
                        >
                          {project.title}
                        </h3>
                      ...
                      <p
                        className="text-[0.9rem] text-muted-foreground mb-3 leading-relaxed"
                        style={{ fontFamily: "var(--t-font-body)" }}
                      >
                        {project.desc}
                      </p>
                      <div
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[0.78rem] mb-4 border-2"
                        style={{
                          fontFamily: "var(--t-font-body)",
                          borderStyle: BS,
                          color: project.category === "Fullstack" ? colors.lime : colors.teal,
                          borderColor:
                            project.category === "Fullstack" ? `${colors.lime}30` : `${colors.teal}30`,
                          backgroundColor:
                            project.category === "Fullstack" ? `${colors.lime}08` : `${colors.teal}08`,
                        }}
                      >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.tags.map((tag) => (
                          <span
                            key={tag}
                            className="px-3 py-1 rounded-full text-[0.73rem] border-2"
                            style={{
            ...
            {projects.length > 4 && (
              ...
              >
                <motion.button
                  type="button"
                  whileHover={{ scale: isCrayon ? 1.04 : 1.08, rotate: 0 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setShowAll(!showAll)}
